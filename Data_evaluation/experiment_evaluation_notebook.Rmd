...
exp_results <- read_csv("../Past_experiments/Pilot2/computed_data/data_all_ans.csv",
...
### Export data for jupyter notebook <./BL_gauging_notebook.ipynb>
...
(I prefer data analysis in R, don't judge)
...
```{r}
con_mat_bl <- confusionMatrix(data=as.factor(adv_rated_data$old_bl_label), reference = as.factor(adv_rated_data$blness_binary))
con_mat_bl
